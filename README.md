...
<h1> My Personal Windows Terminal Configuration</h1>

![PowerShell](https://img.shields.io/badge/PowerShell-7.x-blue) ![Fastfetch](https://img.shields.io/badge/Fastfetch-enabled-green)
...
##### Install Powershell 7.x or the Latest Version
...
- **ANSI/UTF-8 issues**: ensure PowerShell profile sets 
```powershell
[Console]::OutputEncoding = [System.Text.Ecnoding]::UTF8
```
- **Permissions:** run the installer `install.ps1` as **administrator** if you see access errors copying `settings.json`
...
On the next update, i may add `OhMyPosh` on this configuration setup.